...
class Careers(models.Model):
    ...
    caddress = RichTextField(null=True,blank=True)
    paddress = RichTextField(null=True,blank=True)
    dlno =  models.CharField(max_length=30,null=True,blank=True)
    rcno =  models.CharField(max_length=30,null=True,blank=True)
